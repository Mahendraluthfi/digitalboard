...
<head>
  ...
  <title>Login- Digital Project Board</title>
    ...
    <div class="container-fluid">
      <div class="card login-card">
        <div class="card-body">
          ...
          <img src="<?php echo base_url() ?>dist/img/logo.png" alt="AdminLTE Logo" height="30">
          </h2>

          <p class="login-card-description">Digital Project Board</p>
  ...
  <!-- <footer>
    <div class="container">
      <div class="footer-content-wrapper">
        <p class="mb-sm-0">Copyright 2020  bootstrapdash</p>
        <nav>
