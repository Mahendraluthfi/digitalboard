    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <h4><i class="fa fa-hand-holding-usd"></i> Saving</h4>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Embed Style</h4>
            </div>
            <div class="modal-body">
                <?php echo form_open('saving/save'); ?>
                <textarea name="embed" class="form-control" placeholder="Embed Style"><?php echo $get->embed ?></textarea>
            </div>
